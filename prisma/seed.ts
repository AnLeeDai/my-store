  ...
  const products = await Promise.all([
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "iPhone 15 Pro Max với thiết kế titanium, chip A17 Pro mạnh mẽ, camera 48MP và pin lâu dài.",
        inStock: 25,
        brand: "Apple",
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "Samsung Galaxy S24 Ultra với S Pen tích hợp, camera zoom 100x và hiệu năng AI mạnh mẽ.",
        inStock: 30,
        brand: "Samsung",
        categoryId: categories[0].id, // Smartphones
      },
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "MacBook Pro 14 inch với chip M3, màn hình Liquid Retina XDR và thời lượng pin 18 giờ.",
        inStock: 15,
        brand: "Apple",
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "Dell XPS 13 Plus với màn hình 4K, Intel Core i7 thế hệ 13 và thiết kế không viền.",
        inStock: 20,
        brand: "Dell",
        categoryId: categories[1].id, // Laptops
      },
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "AirPods Pro thế hệ 2 với chống ồn chủ động nâng cao, âm thanh không gian và chip H2.",
        inStock: 50,
        brand: "Apple",
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "Logitech MX Master 3S với cảm biến 8000 DPI, cuộn siêu tốc và kết nối đa thiết bị.",
        inStock: 40,
        brand: "Logitech",
        categoryId: categories[2].id, // Accessories
      },
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "PlayStation 5 với SSD tốc độ cao, ray tracing và controller DualSense haptic feedback.",
        inStock: 10,
        brand: "Sony",
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "ASUS ROG Strix GeForce RTX 4070 với DLSS 3, ray tracing và hệ thống tản nhiệt 3 fan.",
        inStock: 8,
        brand: "ASUS",
        categoryId: categories[3].id, // Gaming
      },
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "Google Nest Hub Max với màn hình 10 inch, camera tích hợp và điều khiển nhà thông minh.",
        inStock: 22,
        brand: "Google",
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        fullDescription:
          "Xiaomi Robot Vacuum S10+ với navigation LiDAR, trạm tự động rửa lau và ứng dụng điều khiển.",
        inStock: 18,
        brand: "Xiaomi",
        categoryId: categories[4].id, // Smart Home
      },
